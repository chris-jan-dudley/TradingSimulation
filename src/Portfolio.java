...
public class Portfolio {
    ...
    public HashMap<Company, Integer> getOwnedShares() {
        return ownedShares;
    }

    public void setOwnedShares(HashMap<Company, Integer> ownedShares) {
    ...
    HashMap<Company, Integer> ownedShares;
    int riskValue;
    ...
    public int calculateNetWorth(){
        ...
        for(Company key : ownedShares.keySet()){
            netWorth += (ownedShares.get(key) * key.getSharePrice());
        }
        return netWorth;
    }
